...
// DWI96 Commented-out to avoid conflict with definition in Microsoft <new.h>.
//inline void* operator new(size_t, void* p) {return p;}

// DWI97 Modifed by Rob Wyatt to enable us to monitor how much memory is being
// allocated through the default allocator.
...
inline void deallocate(T* buffer) {
	MEMLOG_SUB_ADRSIZE(emlSTL, buffer);
