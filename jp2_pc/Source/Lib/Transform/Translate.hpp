 ...
 ***********************************************************************************************
 *
 * $Log:: /JP2_PC/Source/Lib/Transform/Translate.hpp                                          $
 * 
 * 10    98.09.19 12:39a Mmouni
...
public:
	...
	// Identity transform.
	forceinline CTranslate3()
		: v3Pos((TR)0, (TR)0, (TR)0)
	{
	}

	forceinline CTranslate3(const CVector3<TR>& v3)
		: v3Pos(v3)
	{
	}

	forceinline CTranslate3(TR t_x, TR t_y, TR t_z)
		: v3Pos(t_x, t_y, t_z)
	{
	}
	...
	forceinline CTranslate3<TR> operator ~() const
	{
	...
	friend forceinline CTranslate3<TR> operator *(const CTranslate3<TR>& tl3_a, const CTranslate3<TR>& tl3_b)
	{
		return CTranslate3<TR>(tl3_a.v3Pos + tl3_b.v3Pos);
	}

	forceinline CTranslate3<TR>& operator *=(const CTranslate3<TR>& tl3)
	{
		v3Pos += tl3.v3Pos;
		return *this;
	}
	...
	friend forceinline CVector3<TR> operator *(const CVector3<TR>& v3, const CTranslate3<TR>& tl3)
	{
		return CVector3<TR>(v3 + tl3.v3Pos);
	}

	friend forceinline CVector3<TR>& operator *=(CVector3<TR>& v3, const CTranslate3<TR>& tl3)
	{
		return v3 += tl3.v3Pos;
	}
	...
	friend forceinline CDir3<TR> operator *(const CDir3<TR>& d3, const CTranslate3<TR>& tl3)
	{
		return d3;
	}

	friend inline CDir3<TR>& operator *=(CDir3<TR>& d3, const CTranslate3<TR>& tl3)
	{
		return d3;
	}
};
