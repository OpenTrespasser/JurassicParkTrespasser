 ...
 ***********************************************************************************************
 *
 * $Log:: /JP2_PC/Source/Lib/Renderer/Primitives/P6/WalkEx.hpp                                 $
 * 
 * 3     9/01/97 8:06p Rwyatt
 * 
 * 2     8/15/97 12:58a Rwyatt
...
//**************************************
{
	...
	//**************************************
	{
		const float fFixed16Scale = 65536.0;		// there is a global one of these in DrawTriangle.cpp
		int32 i4_temp;
