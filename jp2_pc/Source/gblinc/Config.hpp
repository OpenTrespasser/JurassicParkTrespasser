 ...
 ***********************************************************************************************
 *
 * $Log:: /JP2_PC/Source/gblinc/Config.hpp                                                     $
 * 
 * 18    10/01/98 1:22a Asouth
 * MW build should use prefix file to define target processor
 * 
...
#ifdef __MWERKS__
#error TARGET_PROCESSOR not defined
#else
